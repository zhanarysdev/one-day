            ...
            <React.Fragment>
                <header className="header menu_fixed">
                    ...
                    <ul id="top_menu">
                        ...
                        <li>
                            <Link to="/login" id="sign-in" className="login" title="Sign In">Sign In</Link>
                        </li>
                        <li>
                            <a href="wishlist.html" className="wishlist_bt_top" title="Your wishlist">Your wishlist</a>
                        </li>
                    </ul>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="hotels-grid-sidebar-2.html">Hotel grid sidebar 2</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="hotels-list-sidebar-2.html">Hotel list sidebar 2</a>
                                    </li>
                                    <li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="restaurants-grid-isotope.html">Restaurant grid isotope</a>
                                    </li>
                                    <li>
                                        <a href="restaurants-grid-sidebar.html">Restaurant grid sidebar</a>
                                    </li>
                                    <li>
                                        <a href="restaurants-grid-sidebar-2.html">Restaurant grid sidebar 2</a>
                                    </li>
                                    <li>
                                        <a href="restaurants-grid.html">Restaurant grid simple</a>
                                    </li>
                                    <li>
                                        <a href="restaurants-list-isotope.html">Restaurant list isotope</a>
                                    </li>
                                    <li>
                                        <a href="restaurants-list-sidebar.html">Restaurant list sidebar</a>
                                    </li>
                                    <li>
                                        <a href="restaurants-list-sidebar-2.html">Restaurant list sidebar 2</a>
                                    </li>
                                    <li>
