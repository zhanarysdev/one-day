                ...
                <main>
                                            ...
                                            <div className="panel-dropdown">
                                                ...
                                                <div className="panel-dropdown-content">
                                                    ...
                                                    <div className="qtyButtons">
                                                        <label>Adults</label>
                                                        <input type="text" name="qtyInput" value="1"/></div>
                                                    <div className="qtyButtons">
                                                        <label>Childrens</label>
                                                        <input type="text" name="qtyInput" value="0"/></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-lg-2">
                                            <input type="submit" className="btn_search" value="Search"/></div>
                                    </div>
                    ...
                    <div className="container-fluid margin_80_0">
                        ...
                        <div className="container">
                            <p className="btn_home_align">
                                <a href="tours-grid-isotope.html" className="btn_1 rounded">View all Tours</a>
                            </p>
                        </div>

                        <hr className="large"/></div>
                    ...
                    <div className="bg_color_1">
                        <div className="container margin_80_55">
                                ...
                                <div className="col-lg-6">
                                    <a className="box_news" href="#0">
                                        <figure>
                                            ...
                                            <figcaption>
                                                <strong>28</strong>Dec</figcaption>
                                        </figure>
                                        <ul>
                                            <li>Mark Twain</li>
                                            <li>20.11.2017</li>
                                        ...
                                        <p>Cu eum alia elit, usu in eius appareat, deleniti sapientem honestatis eos ex.
                                            In ius esse ullum vidisse....</p>
                                    </a>
                                </div>
                            ...
                            <p className="btn_home_align">
                                <a href="blog.html" className="btn_1 rounded">View all news</a>
                            </p>
                        </div>
                                ...
                                <div className="block-reveal">
                                    ...
                                    <div className="box_1">
                                        ...
                                        <p>Ius cu tamquam persequeris, eu veniam apeirian platonem qui, id aliquip
                                            voluptatibus pri. Ei mea primis ornatus disputationi. Menandri erroribus cu per,
                                            duo solet congue ut.
                                        </p>
